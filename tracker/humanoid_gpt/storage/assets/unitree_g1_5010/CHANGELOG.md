...
**Deploy note:** this model is mechanically/dynamically mode 15, but real
low-level control must validate the asset separately and echo the live
`LowState.mode_machine` into `LowCmd`. Do not force command header 15 solely
because this asset is loaded.
