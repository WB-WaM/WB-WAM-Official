...
def parse_args():
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Defaults to <repo>/checkpoints/tracker/sonic for deploy/training, or tracker/sonic for sample data."
        ),
    )
    parser.add_argument(
        "--no-planner",
...
def main():
    ...
    if args.sample:
        ...
        output_dir = args.output_dir if args.output_dir else wb_root / "checkpoints" / "tracker" / "sonic"
