 ...
 *   - left_wuji_qpos / left_hand_joints  : float[20] or legacy float[7]
 *   - right_wuji_qpos / right_hand_joints: float[20] or legacy float[7]
 *
...
struct PlannerMessage {
  ...
  /// Optional left-hand WujiHand joint targets (20 DOF).
  std::optional<WujiHandJointArray> left_hand_joints;

  /// Optional right-hand WujiHand joint targets (20 DOF).
  std::optional<WujiHandJointArray> right_hand_joints;
