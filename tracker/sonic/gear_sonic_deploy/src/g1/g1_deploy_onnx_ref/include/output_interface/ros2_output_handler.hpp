 ...
 *   left_hand_q          | double[20]   | Left-hand joint positions.
 *   left_hand_dq         | double[20]   | Left-hand joint velocities.
 *   right_hand_q         | double[20]   | Right-hand joint positions.
 *   right_hand_dq        | double[20]   | Right-hand joint velocities.
 *   last_left_hand_action| double[20]   | Last left-hand action.
 *   last_right_hand_action| double[20]  | Last right-hand action.
