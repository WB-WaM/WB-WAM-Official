...
just run g1_deploy_onnx_ref enP8p1s0 ../../../checkpoints/tracker/sonic/policy/release/model_decoder.onnx reference/example/ \
  --obs-config ../../../checkpoints/tracker/sonic/policy/release/observation_config.yaml \
  --encoder-file ../../../checkpoints/tracker/sonic/policy/release/model_encoder.onnx \
  --planner-file ../../../checkpoints/tracker/sonic/planner/target_vel/V2/planner_sonic.onnx \
  --input-type manager \
...
just run g1_deploy_onnx_ref lo ../../../checkpoints/tracker/sonic/policy/release/model_decoder.onnx reference/example/ \
  --obs-config ../../../checkpoints/tracker/sonic/policy/release/observation_config.yaml \
  --encoder-file ../../../checkpoints/tracker/sonic/policy/release/model_encoder.onnx \
  --planner-file ../../../checkpoints/tracker/sonic/planner/target_vel/V2/planner_sonic.onnx \
  --input-type manager \
