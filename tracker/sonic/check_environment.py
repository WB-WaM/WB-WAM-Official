...
def check_git_lfs():
    ...
    sonic_ckpt = Path(__file__).resolve().parents[2] / "checkpoints" / "tracker" / "sonic" / "decoupled_wbc" / "policy" / "GR00T-WholeBodyControl-Balance.onnx"
    sample_file = stl_files[0] if stl_files else str(sonic_ckpt)
