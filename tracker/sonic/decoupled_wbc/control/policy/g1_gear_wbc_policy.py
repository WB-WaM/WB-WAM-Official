...
class G1GearWbcPolicy(Policy):
    ...
    def __init__(self, robot_model, config: str, model_path: str):
        ...
        self.sim2mujoco_root_dir = package_root / "sim2mujoco"
        model_path_1, model_path_2 = model_path.split(",")

        self.policy_1 = self.load_onnx_policy(str(self._resolve_model_path(model_path_1)))
        self.policy_2 = self.load_onnx_policy(str(self._resolve_model_path(model_path_2)))
    ...
    def _resolve_model_path(self, model_path: str) -> Path:
        ...
        if path.is_absolute():
            return path
        return self.sim2mujoco_root_dir / "resources" / "robots" / "g1" / path
